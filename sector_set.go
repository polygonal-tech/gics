...
func NewSectorSet(a ...Sector) SectorSet {
	s := make(SectorSet)
	for _, i := range a {
		s.Add(i)
	}
...
// Iter returns a channel of type Sector that you can range over.
